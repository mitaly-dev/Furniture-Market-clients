...
const {title,productImg,price,phone,name,location,email,category} = order
    console.log(order)
    return (
                ...
                <div className="flex w-full space-x-2 sm:space-x-4">
                    ...
                    <div className="flex flex-col justify-between w-full pb-4">
                        ...
                        <div className="flex text-sm divide-x">
                            <button type="button" className="flex items-center px-2 py-1 pl-0 space-x-1 text-lg font-semibold mr-3">
