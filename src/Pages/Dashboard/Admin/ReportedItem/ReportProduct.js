...
const {category,image,resalePrice,sellerName,title,userEmail,_id} = product
        ...
        <li className="flex flex-col py-6 sm:flex-row sm:justify-between">
                <div className="flex w-full space-x-2 sm:space-x-4">
                    ...
                    <div className="flex flex-col justify-between w-full pb-4">
                        ...
                        <div className="sm:flex text-sm divide-x">
                            <button onClick={()=>reportProductDelete(title)} type="button" className="flex items-center px-2 py-1 pl-0 space-x-1 text-lg font-semibold mr-3">
                            ...
                            <button type="button" className="flex items-center text-left px-2 py-1 space-x-1">
