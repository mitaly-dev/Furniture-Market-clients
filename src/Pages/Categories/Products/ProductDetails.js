...
const ProductDetails = () => {
    ...
    const {title,verify,email,location:userLocation,sellerName,time,yearsOfPurchase,condition,category,originalPrice,resalePrice,_id,image,description} = state
        ...
        <div className="px-4 sm:px-10 lg:px-20 py-16 mx-auto lg:py-20 bg-[#0201010d]">
            ...
            <div className="grid gap-12 lg:grid-cols-2 sm:mx-auto font-jost">
                ...
                <div className='font-jost capitalize pb-5'>
                    ...
                    <span className='text-primary text-lg italic'>Category : {category}</span>
                </div>
                <div className="flex">
                    <div>
                ...
                <div className='text-lg capitalize'>
                    <p><span className='font-semibold'>Location :</span> {userLocation}</p>
